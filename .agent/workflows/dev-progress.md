...
3. [ ] **로컬 테스트** - 변경사항 실제 동작 확인
4. [ ] **배포** - Firebase Hosting 배포

### 우선순위 중간
5. [ ] **기존 하드코딩 JS 파일 정리** - JSON으로 대체 후 제거 가능
   - `incheon-gu-data.js`, `seoul-gu-data.js` 등
6. [ ] **대구, 광주, 대전 동 데이터 추가**
7. [ ] **GitHub Actions CI/CD 구축**

### 우선순위 낮음
8. [ ] **PerformanceUtils 실제 적용** - 지도 렌더링 최적화
9. [ ] **DataLoader 전면 통합** - 기존 하드코딩 완전 대체
